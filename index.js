...
var getTranslationsFromFiles = function (locale, ns) {
    if (locale === void 0) { locale = translationsConfig.defaultLocale; }
    if (ns === void 0) { ns = []; }
    return __awaiter(_this, void 0, void 0, function () {
        var translations, _i, ns_1, namespace, folderPath, exists_1, translationsJson, err_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    namespace = ns_1[_i];
                    folderPath = "../..".concat(translationsConfig.outputFolderTranslations, "/").concat(locale, "/").concat(namespace, ".json");
                    return [4 /*yield*/, fse.pathExists(path.resolve(__dirname, folderPath))];
                case 3:
                    exists_1 = _b.sent();
                    if (!exists_1) return [3 /*break*/, 5];
                    return [4 /*yield*/, fse.readJson(path.resolve(__dirname, folderPath))];
                case 4:
                    translationsJson = _b.sent();
                    if (translationsJson) {
                        translations = __assign(__assign({}, translations), (_a = {}, _a[namespace] = translationsJson, _a));
                    }
                    return [3 /*break*/, 6];
                case 5:
                ...
                case 6:
                    _i++;
                    return [3 /*break*/, 2];
                case 7: return [2 /*return*/, { translations: translations }];
                case 8:
                    err_1 = _b.sent();
                    console.error(err_1);
                    return [3 /*break*/, 9];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = [{}];
                    return [4 /*yield*/, getTranslationsFromFiles(locale, __spreadArray(__spreadArray([], ns, true), defaultNamespacesToUseInAllPages, true))];
                case 1:
...
var getPaths = function () {
    return allTranslationsLanguages
        .filter(function (item) { return item !== translationsConfig.languageWithoutMultirouting; })
